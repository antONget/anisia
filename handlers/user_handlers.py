...
async def process_buttons_press_video1(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    await callback.message.answer(text=f"{LINK_VIDEO['video1']}{LINK_VIDEO['video1']}")
    await asyncio.sleep(3 * minutes)
...
async def process_buttons_press_video2(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    await callback.message.answer(text=f"{LINK_VIDEO['video2']}{LINK_VIDEO['video2']}")
    await asyncio.sleep(3 * minutes)
...
async def process_buttons_press_video1(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    await callback.message.answer(text=f"{LINK_VIDEO['video3']}{LINK_VIDEO['video3']}")
    await asyncio.sleep(3 * minutes)
